...
ParallelIntepreter::ParallelIntepreter(int yDir, int yStep, int zDir, int zStep, int aDir, int aStep, int xDir, int xStep, int enPin, int sY_front, int sY_back, int sZ_front, int sZ_back, int fieldSize)
